...
;;
;funkcja do liczenia potegi pierwszy parametr podstawa wykladnik to ecx drugi parametr to gdzie zapisac
;@param pierwszy parametr podstawa [esp + 8]
;@param drugi par to wykladnik [ebp + 12] 
;@param drugi par to adres do zmiennej [esp + 16]
;;
powerFunction:	
	push ebp
	mov ebp, esp
